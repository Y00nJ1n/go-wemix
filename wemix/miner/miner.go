...
var (
	...
	CalculateRewardsFunc        func(bool, *big.Int, *big.Int, *big.Int, func(common.Address, *big.Int), func(common.Address) *big.Int) (*common.Address, []byte, error)
...
func CalculateRewards(isBrioche bool, num, blockReward, fees *big.Int, addBalance func(common.Address, *big.Int), getBalance func(common.Address) *big.Int) (*common.Address, []byte, error) {
	if CalculateRewardsFunc == nil {
		...
		return CalculateRewardsFunc(isBrioche, num, blockReward, fees, addBalance, getBalance)
	}
}
